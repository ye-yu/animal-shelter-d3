function animalAdoption(directoryPrefix="") {
  ...
  .attr('text-anchor', 'middle')
  .attr('class', 'vis-body')
  .attr("x", radius - 2* smallCircleMargin)
  .attr("y", 2 * radius + 3* smallCircleMargin - (smallCircleMargin/7))
  .style("color", "black")
  .text("2017");
  svg_all.append('text')
  .attr('text-anchor', 'middle')
  .attr('class', 'vis-body')
  .attr("x", radius - 2* smallCircleMargin)
  .attr("y", 2 * radius + 3* smallCircleMargin + (smallCircleMargin/2))
  .style("color", "black")
  .text("2018");
  svg_all.append('text')
  .attr('text-anchor', 'middle')
  .attr('class', 'vis-body')
  .attr("x", radius - 2* smallCircleMargin)
  .attr("y", 2 * radius + 3* smallCircleMargin + (smallCircleMargin)+ (smallCircleMargin/7))
  .style("color", "black")
  .text("2019");
